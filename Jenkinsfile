pipeline {
  ...
  environment {
    ...
    SONAR_URL   = 'http://13.53.124.117:9000'
    NEXUS_URL   = 'http://13.53.124.117:9000'
  }
...
EOF'''
      ...
      sh 'mvn deploy -B -s settings.xml -DaltDeploymentRepository=nexus::http://13.53.124.117:8081/repository/maven-snapshots/'
    }
  }
}
  }
